...
<body>
  ...
  <main>
    <div class="main">
      ...
      <p style="max-width: 630px;">Будь ласка, введіть новий пароль, та введіть його знову</p>
        <div class="fields">
          <form action="/login/verify/reset" method="POST" style="display: contents">
            <label>
              @csrf
              <input name="pwd1" required="required" type="password" placeholder="Пароль">
            </label>
            <label>
              @csrf
              <input name="pwd2" required="required" type="password" placeholder="Повторіть пароль">
            </label>
